  ...
  <div class="app-container">
    <div class="block">
      ...
      <el-form :inline="true" class="demo-form-inline">
        ...
        <!-- 新增课程 -->
        <el-button type="primary" style="float:right" icon="el-icon-plus" @click="addCourse" circle></el-button>
      </el-form>
      ...
      <el-table :data="courseList" border style="width: 100%" v-loading="loading">
        ...
        <el-table-column prop="viewCount" label="学习人数"></el-table-column>
        ...
        <!-- <el-table-column prop="courseChapter" label="课程章节"></el-table-column> -->
...
export default {
  ...
  methods: {
    ...
    search: function () {
      ...
      this.httpPost("/video/course/list", param).then(
        (res) => {
          this.courseList = res.data.data;
          this.totalCount = res.data.total;
          this.loading = false;
     ...
     * 时间格式化
     */
    dateFormat(roww, column, cellValue, index) {
